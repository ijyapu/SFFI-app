...
// Context to share search term with SelectItem children
...
function SelectItem({
  ...
  // Filter: hide item if it doesn't match the search term
  if (
    search &&
    resolvedLabel &&
    !resolvedLabel.toLowerCase().includes(search.toLowerCase())
  ) {
    return null
  }
