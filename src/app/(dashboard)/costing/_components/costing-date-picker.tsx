...
const PRESETS = [
  {
    label: "This Month",
    from: () => fmt(startOfMonth(nepalNow())),
    to:   () => fmt(endOfMonth(nepalNow())),
  },
  {
    label: "Last Month",
    from: () => fmt(startOfMonth(subMonths(nepalNow(), 1))),
    to:   () => fmt(endOfMonth(subMonths(nepalNow(), 1))),
  },
  {
    label: "Last 3 Months",
    from: () => fmt(startOfMonth(subMonths(nepalNow(), 2))),
    to:   () => fmt(endOfMonth(nepalNow())),
  },
  {
    label: "This Year",
    from: () => fmt(startOfYear(nepalNow())),
    to:   () => fmt(endOfMonth(nepalNow())),
  },
];
